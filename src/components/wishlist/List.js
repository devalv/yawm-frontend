...
class Wishlist extends Component {
    ...
    state = {
        producerWishlistEndpoint: process.env.REACT_APP_API_URL + '/wishlist/',
        userLoggedIn: false,
        // TODO: @devalv rename
        wishlists: []
    };
    ...
    getWishlists = () => {
        ...
        fetch(this.state.producerWishlistEndpoint, request)
        .then(response => {
    ...
    render() {
        const wishlists_list = this.state.wishlists;
        ...
        return (
            ...
            <Container>
                ...
                <Row xs={1} md={3} xxl={4} className="g-4">
                    {/* TODO: @devalv active new wishlist card for a registered users */}
                    {/* TODO: @devalv disabled new wishlist card for a anonymous users */}

                    {wishlists_list.map(wishlist => (
                        <Card key={wishlist.id}>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>Wishlist by `{wishlist.username}` created at {wishlist.created_at}</Card.Text>
